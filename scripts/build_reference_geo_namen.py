...
ORTE_CH: list[tuple[str, str, str, str, float]] = [
    ...
    ("8004", "Zürich", "ZH", "de", 30), ("8005", "Zürich", "ZH", "de", 15), ("8032", "Zürich", "ZH", "de", 20),
    ("8050", "Zürich", "ZH", "de", 35), ("8057", "Zürich", "ZH", "de", 25), ("8408", "Winterthur", "ZH", "de", 20),
    ("8708", "Männedorf", "ZH", "de", 11), ("8600", "Dübendorf Gfenn", "ZH", "de", 2),
    ("8500", "Frauenfeld", "TG", "de", 26),
    # Bern
    ("3000", "Bern", "BE", "de", 135), ("3012", "Bern", "BE", "de", 25), ("3014", "Bern", "BE", "de", 20),
    ("3600", "Thun", "BE", "de", 45),
    ...
    # Luzern
    ("6003", "Luzern", "LU", "de", 82), ("6004", "Luzern", "LU", "de", 20), ("6005", "Luzern", "LU", "de", 15),
    ("6010", "Kriens", "LU", "de", 28),
    ...
    ("4051", "Basel", "BS", "de", 175), ("4053", "Basel", "BS", "de", 30), ("4058", "Basel", "BS", "de", 25),
    ("4125", "Riehen", "BS", "de", 21),
    ...
    ("1201", "Genève", "GE", "fr", 200), ("1205", "Genève", "GE", "fr", 30), ("1207", "Genève", "GE", "fr", 25),
    ("1227", "Carouge GE", "GE", "fr", 22),
...
ORTE_DE: list[tuple[str, str, str, float]] = [
    ...
    ("04357", "Leipzig", "SN", 80), ("04277", "Leipzig", "SN", 70), ("04416", "Markkleeberg", "SN", 25), ("04509", "Delitzsch", "SN", 25),
